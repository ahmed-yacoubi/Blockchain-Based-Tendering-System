...
function editNameM() {
    ...
    contract.methods.editInfo(0, 0, convertStringToBytes(name, 16)).send({ from: accounts[0] }).then(function () {
...
function editPhoneM() {
    ...
    contract.methods.editInfo(0, 1, convertStringToBytes(phone, 16)).send({ from: accounts[0] }).then(function () {
        window.location.href = "/";
